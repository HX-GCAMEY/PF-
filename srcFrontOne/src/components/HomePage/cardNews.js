  ...
  return (
    <Pressable style={styles.containerCards}>
      <View style={styles.imagenContainer}>
        <Image source={{ uri: item.background }} style={{ width: 300, height: ANCHO_CONTENEDOR * 0.8, resizeMode: 'cover', borderRadius: 24, margin: 10, marginBottom: 60, marginTop: 2, opacity: 1 }} />
