...
const Filters = ({ flightsComponent, dispatched }) => {
  ...
  */ const dispatch = useDispatch()
  ...
  let b = flightsComponent.filter(e => {
    if (e.departure.city.includes(d)) return e;
    if (e.arrival.city.includes(d)) return e;
                 if(e.departure.airport.includes(d)) return e;
                if( e.arrival.airport.includes(d)) return e;
                 if(e.departure.date.includes(d)) return e;
                if( e.arrival.date.includes(d)) return e;
                 if(e.departure.time.includes(d)) return e;
                 if(e.arrival.time.includes(d)) return e;
                 if(e.totalSeats.includes(d)) return e;

                 if(e.duration.includes(d)) return e;

    if (e.number.includes(d)) return e;
  }
return b
                } */
